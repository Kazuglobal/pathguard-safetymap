-- Harden RPC: get_accidents_in_bbox
-- - enforce bounded limit server-side
-- - normalize bbox/year inputs
-- - avoid accidental privilege escalation by using SECURITY INVOKER
