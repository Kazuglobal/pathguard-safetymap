        ...
        headers: [
          ...
          // CSP は Report-Only モードで動作確認中。問題がなければ Content-Security-Policy に切り替える。
          {
            ...
            value: [
              ...
              "connect-src 'self' data: https://*.supabase.co wss://*.supabase.co https://api.mapbox.com https://events.mapbox.com https://api.jartic-open-traffic.org https://tile.googleapis.com https://maps.googleapis.com https://vercel.live wss://*.vercel.live",
