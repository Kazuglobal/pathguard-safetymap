...
export function LpShowcase() {
  return (
    <section className="overflow-hidden bg-[#F3EFE4] py-28 md:py-36">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        ...
        <h2
          data-reveal
          className="font-lp-display max-w-2xl text-3xl font-black leading-snug text-[#2B2723] md:text-[2.6rem] md:leading-[1.35]"
        >
          スマホでも、パソコンでも。<br />家族みんなの手のなかに。
        </h2>
        <p data-reveal className="mt-5 max-w-xl text-base leading-loose text-[#2B2723]/70">
        ...
        <div className="mt-28 grid items-center gap-10 md:mt-36 md:grid-cols-2">
          <div data-reveal className="order-2 md:order-1">
            ...
            <h3 className="font-lp-display mt-3 text-2xl font-black leading-snug text-[#2B2723] md:text-3xl">
              今夜は、家族で
              <br />
              「つうがくろ作戦会議」。
            </h3>
            <p className="mt-5 text-base leading-loose text-[#2B2723]/70">
              PathGuardian が目指すのは、画面の中の安心ではなく、家族の会話が増えること。今日のニュースをきっかけに、明日の通学路をいっしょに歩く計画を立てる — そんな毎日をつくります。
            </p>
          </div>
          <div data-reveal className="order-1 overflow-hidden rounded-3xl shadow-[0_40px_80px_-32px_rgba(43,39,35,0.35)] md:order-2">
