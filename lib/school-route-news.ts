...
export const NEWS_ITEMS: SchoolRouteNewsItem[] = [
  {
    ...
    title: "【福岡県】帰宅中の男児が腕をつかまれそうに 2日間で3件の声かけ・つきまとい",
    excerpt: "福岡県内で9月15日から16日にかけ、下校・帰宅中の子どもへの不審な事案が3件相次いだ。16日午後6時30分ごろ福岡市早良区四箇6丁目で小学生男児が腕をつかまれそうになり、その10分後に城南区七隈4丁目で女児がつきまとわれた。",
    content: `## 事案の概要

福岡県内で2026年9月15日（火）から16日（水）にかけて、下校中・帰宅中の子どもを対象とした不審な事案が**3件**、警察の防犯メール（ふっけい安心メール）で配信されました。うち2件は**9月16日の夕方、10分の間に福岡市の隣り合う区**で起きています。
...
今回の3件のうち2件は**午後6時半すぎ**です。9月中旬の福岡の日没は午後6時半前後で、ちょうど外が急に暗くなる時間帯にあたります。学校からまっすぐ帰る時間ではなく、習い事や遊びから戻る「帰り道」が重なる時間です。

見守りの人が立つのは登校時と下校直後が中心で、この時間帯は大人の目が薄くなります。加えて、9月に入ると日没が日ごとに早まるため、「先週は明るかった道」が今週は暗い、という変化が起こります。

一方で、門司区の1件は**子どもが「おかしい」と気づいて大人に伝えた**ことで情報として共有され、地域の警戒につながりました。気づいて伝えることには意味があります。
...
5. **気づいたら伝える**：「変だと思ったら、その日のうちにおうちの人か先生に言う」と約束しておく。門司区の事案は、それが共有のきっかけになった
...
- 福岡県警察 ふっけい安心メール配信（情報提供元：門司警察署、2026年9月15日発生分）／アーカイブ「あんあんネットふくおか」`,
    ...
    tags: ["不審者", "声かけ事案", "つきまとい", "福岡県", "福岡市", "北九州市", "帰宅中", "下校中", "防犯メール"],
    sources: [
      "西日本新聞me「福岡市早良区で小学生男児が腕をつかまれそうになる事案発生 四箇6丁目の路上」（2026年9月17日）",
    ...
    keyPoints: [
      "9月15日から16日にかけて福岡県内で下校・帰宅中の子どもへの不審な事案が3件。16日は午後6時30分と6時40分に福岡市早良区・城南区で相次ぎ、男子児童が腕をつかまれそうになる事案も起きた（福岡県警の防犯メール配信による）",
      "腕をつかまれたら持ち物を捨てて全力で走ると決め、今夜いっしょに声を出す練習をする"
    ],
    isBreaking: false,
