...
- PTA・地域と連携した見守り体制の確認`,
  ...
  {
    id: "news-2026-01-20-001",
    slug: "mext-nationwide-alert-consecutive-accidents-20260120",
    title: "文科省が全国に異例の注意喚起 - 登下校事故の連続発生を受けて",
    excerpt: "1月に大阪、埼玉、福岡で下校中の児童に車が突っ込む事故が相次いで発生。阿部文科相が「異例の事態」として全国の教育委員会に注意喚起を実施。",
    content: `## 事故の連続発生

2026年1月、わずか19日間で3件の登下校事故が発生しました。

### 発生した事故
- **1月1日**: 大阪市西成区で下校中の児童に車が突っ込む
- **1月14日**: 埼玉県三郷市で登下校中の児童に車が突っ込む
- **1月19日**: 福岡県筑紫野市で下校中の小学生4人が車にはねられる

### 文部科学省の対応

阿部俊子文部科学大臣は1月20日の閣議後会見で、「連続して発生しているのは異例の事態」と述べ、全国の教育委員会に注意喚起を行ったことを発表しました。

文科省は事故の詳細を分析し、今後の対策を検討するとしています。

### 予算措置

文科省は本年度、通学路の見守り活動のためスクールガードリーダーの配置事業などに、**2億4千万円の予算**を充てています。

### 求められる対策

この異例の注意喚起は、以下の点を改めて浮き彫りにしました。

1. **ハード対策の限界**
   物理的な安全設備だけでは、人的要因による事故を完全には防げない

2. **見守り活動の重要性**
   地域の大人の目が、子どもたちの安全を守る重要な役割を果たす

3. **ドライバーの注意喚起**
   特に登下校時間帯の通学路周辺では、最大限の注意が必要

4. **継続的な安全教育**
   子どもたち自身が危険を回避する力を身につけることが不可欠`,
    category: "policy",
    categoryLabel: "施策・対策",
    categoryColor: "#8B5CF6",
    categoryIcon: "FileText",
    publishedDate: "2026-01-20T14:00:00+09:00",
    location: {
      prefecture: "全国"
    },
    tags: ["文部科学省", "注意喚起", "登下校事故", "スクールガード", "予算措置"],
    sources: [
      "日本教育新聞電子版 NIKKYOWEB",
      "文部科学省",
      "阿部文部科学大臣 閣議後会見（2026年1月20日）"
    ],
    keyPoints: [
      "1月に大阪、埼玉、福岡で登下校事故が連続発生",
      "阿部文科相が「異例の事態」として全国の教育委員会に注意喚起",
      "スクールガード配置事業に2億4千万円の予算措置"
    ],
    thumbnailUrl: "/images/school-route-news/thumbnails/mext-nationwide-alert.png",
    isBreaking: false,
    verifiedAt: "2026-01-20T16:00:00+09:00"
  },
  {
    id: "news-2026-01-19-001",
    slug: "fukuoka-asakura-bicycle-accident-20260119",
    title: "福岡県朝倉市で自転車の小学生2人が車にはねられ1人死亡",
    excerpt: "1月19日午後3時50分頃、朝倉市屋永の市道交差点で、自転車に乗っていた小学2年生の男児2人が車にはねられ、1人が死亡、1人が頭や腕に怪我。",
    content: `## 事故の概要

2026年1月19日午後3時50分頃、福岡県朝倉市屋永の市道で、自転車に乗っていた小学2年生の男児2人（いずれも8歳）が乗用車にはねられました。

### 被害状況
- 男児1人が死亡
- もう1人が頭部と腕に外傷を負い病院に搬送

### 事故の状況
- 現場は信号機のない交差点
- 西進していた乗用車と北進していた自転車の男児2人が衝突
- 運転者は容疑を認めている

### 逮捕
福岡県警は、福岡県筑前町朝日在住の会社役員・田辺武男容疑者（53）を自動車運転処罰法違反の疑いで逮捕しました。`,
    category: "accident",
    categoryLabel: "交通事故",
    ...
    keyPoints: [
      "自転車の小学2年生2人が信号なし交差点で車にはねられた",
      "1人死亡、1人が頭部と腕に外傷",
      "運転者（53歳）を逮捕、容疑を認めている"
    ],
  ...
  {
    id: "news-2025-12-15-001",
    slug: "zone30plus-65-model-areas-20251215",
    title: "国交省「ゾーン30プラス」全国65箇所のモデル地域を選定",
    excerpt: "国土交通省は通学路の面的な交通安全対策として、小学校周辺65箇所を「ゾーン30プラス」モデル地域に選定。速度規制と物理的デバイスを組み合わせた対策を推進。",
    content: `## ゾーン30プラスとは

国土交通省は、通学路における交通安全の取組を推進するため、小学校等周辺において面的な交通安全対策を促進する「モデル地域」を全国65箇所選定しました。
...
### 今後の展開
モデル地域での取組から得られた知見を活用し、全国の通学路に対策を展開していく予定です。`,
    category: "infrastructure",
    categoryLabel: "インフラ整備",
    categoryColor: "#3B82F6",
    categoryIcon: "Construction",
    publishedDate: "2025-12-15T10:00:00+09:00",
    location: {
      prefecture: "全国"
    },
    tags: ["ゾーン30プラス", "国土交通省", "通学路", "速度規制", "モデル地域"],
    sources: [
      "国土交通省 報道発表資料",
      "警察庁",
      "けんせつPlaza"
    ...
    keyPoints: [
      "全国65箇所のモデル地域を選定",
      "速度30km/h規制と物理的デバイスの組み合わせ",
      "ETC2.0データを活用した交通実態分析"
    ],
    thumbnailUrl: "/images/school-route-news/thumbnails/zone30plus-model.png",
    verifiedAt: "2025-12-16T09:00:00+09:00"
  },
  {
